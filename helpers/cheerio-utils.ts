...
export const findLabelWithText = (dom: AwaitedReturnType<typeof scrape>, text: string) => {
  return dom('b')
    .toArray()
    .map(mapToCheerio)
...
export const getNextSiblingTextNodeData = (el?: ReturnType<typeof mapToCheerio>) => {
